...
public class CommConstant
{
    ...
    public static final String SYMBOL_QUERY = "?";
    ...
    public static final String SYMBOL_FILE_SEPARATOR= "/";
    ...
    public static Map<Long, String> weidianURL = new HashMap<Long, String>();
}
