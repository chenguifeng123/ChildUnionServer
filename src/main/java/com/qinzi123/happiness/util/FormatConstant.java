...
public class FormatConstant
{
    ...
    public static final String DATETIMETYPE_SIMPLE = "yyyy年MM月dd日 HH:mm";

    public static final String DATETIMETYPE_SIMPLE_NOYEAR = "MM月dd日 HH:mm";

    public static final String DATETIMETYPE_SIMPLE_TODAY = "今天HH:mm";
