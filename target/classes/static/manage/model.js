    ...
    methods: {
        ...
        ************************************************************************************** */
        ...
        refresh :function(){
            ...
            this.modelRefs = [];
            for(var index = 0; index < columns.length; index++){
                !isEmptyObj(columns[index].refs) ? this.modelRefs.push({colIndex : index, name : columns[index].name, refs : columns[index].refs})
        ...
        makeDialogData : function(){
            ...
            for(var index = 0; index < this.tableMeta.columns.length; index++){
                ...
                var value = oneColumn.value instanceof Date ? oneColumn.value.format("yyyy-MM-dd") : (
